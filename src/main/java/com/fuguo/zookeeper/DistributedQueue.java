...
public class DistributedQueue {
    ...
    public static void main(String[] args){
        try {
            ...
            DistributedQueue distributedQueue = new DistributedQueue(zooKeeper, "/zoo", null);
            System.out.println(new String(distributedQueue.take()));
//            String connectionString = "127.0.0.1:2181";
//            int sessionTimeout = 30000;
//            ZooKeeper zk = new ZooKeeper(connectionString,sessionTimeout,null);
////            zk.create("/zoo", "version-3".getBytes(),
////                    ZooDefs.Ids.OPEN_ACL_UNSAFE,
////                    CreateMode.PERSISTENT);
//            //System.out.println(new String(zk.getData("/zoo", false, null)));
//            zk.setData("/zoo", "shanhy20160310-ABCD".getBytes(), -1);
//            System.out.println(new String(zk.getData("/zoo", false, null)));
        } catch (Exception e) {
            e.printStackTrace();
        }
